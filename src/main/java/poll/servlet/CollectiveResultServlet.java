...
@WebServlet(urlPatterns = "/collective")
public class CollectiveResultServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (result < 9) {
            ...
            String decision = new ResultManager().findByWeightAndPollId(result, 3).getExplanation();
